...
class SkinPurchasePage extends Component {
    constructor(props) {
        super(props)
    ...
    handleConfirm(e) {
        e.preventDefault()
        this.props.addSkin(this.state.items[0].id)
    }
...
export default connect(mapStateToProps,actionCreators)(SkinPurchasePage);
